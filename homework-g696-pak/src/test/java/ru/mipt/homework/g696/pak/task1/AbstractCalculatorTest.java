...
import ru.mipt.homework.g696.pak.task1.Calculator;
import sun.security.pkcs.ParsingException;

/**
 * Оснастка для тестирования {@link Calculator}. Для запуска нужно определить конкретный
 * класс-потомок и определить ему метод {@link #calc()}
 *
